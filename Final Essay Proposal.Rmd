...
The papers that I have chosen thus far focus on a couple different topics, subjectivism, simulations, normative relevance in economics and knowledge problems.  They seek to identify issues with certain schools of thought within the economic sphere and try to identify the best ways to go about economic research.  I particularly enjoyed "A Plea for (Good) Simulations:Nudging Economics Toward an Experimental Science" by Julian Reiss because it raises the false concerns that researches have with respect to simulations and makes a very good case for the validity of this empirical approach in the future.  

## Outline

    - Introduction
    
    - Shortfalls with a mathematical approach to optimization within economies
    - Shortfalls with purely behvaioral approach to optimization within economies
    - A happy medium with both a mathematical and empirical approach to optimization
    - New possibilities with AI simulation
